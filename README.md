...
|---------|--------|--------|----------|
| <img src="./screenshots/settings.png" width="70%"> | ![](./screenshots/admin-analytics.png) | <img src="./screenshots/admin.png" width="85%"> | <img src="./screenshots/search.png" width="70%"> |
---
## 🚀 Quick Start
