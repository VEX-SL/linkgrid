...
|---------|--------|--------|----------|
| <img src="./screenshots/settings.png" width="25%"> | ![](./screenshots/admin-analytics.png) | <img src="./screenshots/admin.png" width="50%"> | <img src="./screenshots/search.png" width="25%"> |
---
## 🚀 Quick Start
